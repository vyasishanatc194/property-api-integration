...
class Refefile extends Model
{
    ...
    {
		if($this->refe_file_path && $this->refe_file_name && \File::exists(public_path('/')."/".$this->refe_file_path."/thumb/".$this->refe_file_name)){
			return url("/")."/".$this->refe_file_path."/thumb/".$this->refe_file_name;
		}else{
    ...
    {
		if($this->refe_file_path && $this->refe_file_name && \File::exists(public_path('/')."/".$this->refe_file_path."/thumb/".$this->refe_file_name)){
			return public_path("/")."/".$this->refe_file_path."/thumb/".$this->refe_file_name;
		}else{
			return "";
		}
	}
