                        ...
                        <div class="card-block">
                            ...
                            <form class='validate-form' role="form" method="POST" action="{{ url('sign-in') }}">
                                ...
                                <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
                                    <div class="col-md-12">
                                        <input name="email" type="text" value="{{ isset($_COOKIE['email'])? $_COOKIE['email'] : old('email') }}" class="form-control"  placeholder="@lang('comman.label.email')"  >
                                        @if ($errors->has('email'))
                                ...
                                <div class="form-group {{ $errors->has('password') ? ' has-error' : '' }}">
                                    <div class="col-md-12">
                                        <input type="password" name="password" value="{{ isset($_COOKIE['password'])? $_COOKIE['password']:'' }}" placeholder="@lang('comman.label.password')" class="form-control" >
